...
function scrollHeader() {
  ...
  // when the scroll is greater than 50 viewport height, add the scroll-header clas to header tag
...
function scrollUp() {
  ...
  // when the scroll is higher than 350 viewport height, add the show-scrollup
